...
class EntitiesService(
    ...
    private fun showForm(
        ...
        uiProvider.showForm(this, workspaceServices, spec, mode, data, onCancel, onSubmit)
    }
    ...
    private suspend fun showForm(
        ...
        return uiProvider.showForm(this, workspaceServices, spec, mode, data)
    }
    ...
    private fun <T : Any> wrapEntitiesToInfo(defWithRepo: EntityDefWithRepo<Any, T>, entities: List<T>): List<EntityInfo<T>> {
        ...
        actions.add(
            ActionDesc(
                ...
                val confirmRes = uiProvider.confirm(
        ...
        showForm(
            ...
            Thread.ofPlatform().name("create-entity-${definition.typeId}").start {
                ActionStatus.doWithStatus { status ->
                    val closeLoading = uiProvider.showLoading(status)
                    try {
                        database.doWithinTxn {
