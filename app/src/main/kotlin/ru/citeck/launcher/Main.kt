...
import ru.citeck.launcher.view.ui.ComposeUiProvider
            ...
            Window(
                ...
                val servicesValue = remember {
                    if (tryToLockError != null) {
                        ...
                        Thread.ofPlatform().start {
                            try {
                                val launcherServices = LauncherServices(ComposeUiProvider())
                            ...
                            Thread.ofPlatform().start {
                                try {
                                    ...
                                    if (launcherServices != null) {
                                        ...
                                        val newServices = LauncherServices(ComposeUiProvider())
