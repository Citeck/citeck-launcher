...
import ru.citeck.launcher.core.form.FormContext
...
class ComposeFormContext(
    ...
    override fun listenChanges(fields: Set<String>, action: (String, Any?) -> Unit) {
        if (fields.isEmpty()) {
            return
        }
        for (field in fields) {
    ...
    override fun getStrValue(key: String): String {
