...
const ja = {
  ...
  'dashboard.openInBrowser.held': '一部のアプリが停止中の依存関係を待機しています。それらを起動するとアプリケーションが利用可能になります。',
  ...
  'registryCreds.manageTitle': '{host} の認証情報',
  'registryCreds.manageExplain': '{host} からイメージを取得する際にランチャーが使用する保存済み認証情報を選択します。',
  'registryCreds.manageSave': '認証情報を保存',
  'migrationDegraded.title': '1.x からのアップグレードでデータの一部のみが復元されました',
  'migrationDegraded.titlePartial': 'アップグレード時にデータの一部を読み取れませんでした',
  'migrationDegraded.bodyPartial': '旧データベースは開けましたが、{entries} 件のレコードと {subtrees} 件のサブツリーをデコードできず、次の場所でスキップされました: {maps}。ワークスペース、ネームスペース、シークレットが揃っているか確認してください。',
  'migrationDegraded.body': '旧データベースを読み取れなかったため、ランチャーはディスクから復元できる範囲のみを再構築しました: ワークスペース {workspaces} 件、ネームスペース {namespaces} 件、リポジトリ URL {recovered} 件。シークレットは引き継がれていないため、レジストリと git の認証情報を再入力してください。',
  'migrationDegraded.backup': '元の 1.x データベースは {path} にそのまま残っています。',
  'migrationDegraded.reason': '原因: {reason}',
  'registryCreds.saved': '認証情報を保存しました',
  'registryCreds.remove': '紐付けを解除',
  'registryCreds.removed': 'レジストリの紐付けを解除しました',
  'registryCreds.removeTooltip': '{host} で現在使用中の認証情報の紐付けを解除します',
  ...
  'workspace.config.title': '\u30ef\u30fc\u30af\u30b9\u30da\u30fc\u30b9\u8a2d\u5b9a',
  'workspace.config.hint': 'workspace-v1.yml \u3092\u7de8\u96c6\u3057\u307e\u3059\u3002\u5909\u66f4\u306f git \u30ea\u30d5\u30a1\u30ec\u30f3\u30b9\u3078\u306e\u30aa\u30fc\u30d0\u30fc\u30ec\u30a4\u3068\u3057\u3066\u4fdd\u5b58\u3055\u308c\u3001\u540c\u671f\u306e\u305f\u3073\u306b\u518d\u9069\u7528\u3055\u308c\u307e\u3059\u3002',
  'workspace.config.invalidYaml': '\u7121\u52b9\u306a YAML: {error}',
  'workspace.config.saved': '\u30ef\u30fc\u30af\u30b9\u30da\u30fc\u30b9\u8a2d\u5b9a\u3092\u4fdd\u5b58\u3057\u307e\u3057\u305f',
  'workspace.config.reset': 'git \u306b\u30ea\u30bb\u30c3\u30c8',
  'workspace.config.resetTooltip': '\u5909\u66f4\u3092\u7834\u68c4\u3057\u3066 git \u30ea\u30d5\u30a1\u30ec\u30f3\u30b9\u306b\u623b\u3059',
  'workspace.config.resetSuccess': '\u30ef\u30fc\u30af\u30b9\u30da\u30fc\u30b9\u8a2d\u5b9a\u3092 git \u30ea\u30d5\u30a1\u30ec\u30f3\u30b9\u306b\u30ea\u30bb\u30c3\u30c8\u3057\u307e\u3057\u305f',
  'workspace.config.rawEdit': 'workspace-v1.yml を編集...',
  ...
  'secretPicker.hostMismatch': 'このシークレットは {host} のものであり、このレジストリのものではありません',
  ...
  'config.workspace.title': 'ワークスペース',
  'config.workspace.desc': 'ランチャーがバンドル、アプリケーション、ネームスペーステンプレートを読み込む Git リポジトリです。',
  'config.workspace.settings': 'ワークスペース設定...',
  'config.workspace.editTitle': 'ワークスペース設定',
  'config.workspace.none': 'アクティブなワークスペースがありません',
  'config.registry.title': 'レジストリ認証情報',
  'config.registry.desc': 'プライベート Docker レジストリからイメージを取得するための認証情報です。各ホストは 1 つの保存済みシークレットに紐づきます。',
  'config.registry.colHost': 'レジストリホスト',
  'config.registry.colSecret': '認証情報',
  'config.registry.configure': '設定',
  'config.registry.unbound': '未設定',
  'config.registry.unknownSecret': 'シークレットが見つかりません: {id}',
  'config.registry.empty': '認証情報が必要なレジストリはまだありません。',
  ...
  'logViewer.download.saved': '\u30ed\u30b0\u3092\u30c0\u30a6\u30f3\u30ed\u30fc\u30c9\u306b\u4fdd\u5b58\u3057\u307e\u3057\u305f',
  'logViewer.download.openFolder': '\u30d5\u30a9\u30eb\u30c0\u3092\u958b\u304f',
  'logViewer.download.failed': '\u30ed\u30b0\u306e\u4fdd\u5b58\u306b\u5931\u6557\u3057\u307e\u3057\u305f',
  'logViewer.clear': '\u30af\u30ea\u30a2',
  'logViewer.clear.tooltip': '\u30ed\u30b0\u3092\u30af\u30ea\u30a2 (Ctrl+L)',
  'logViewer.empty': '\u30ed\u30b0\u304c\u3042\u308a\u307e\u305b\u3093',
  'imageDetails.title': '\u30a4\u30e1\u30fc\u30b8\u306e\u8a73\u7d30',
  'imageDetails.tooltip': '\u30a4\u30e1\u30fc\u30b8\u306e\u8a73\u7d30',
  'imageDetails.id': '\u30a4\u30e1\u30fc\u30b8ID',
  'imageDetails.digest': '\u30c0\u30a4\u30b8\u30a7\u30b9\u30c8',
  'imageDetails.size': '\u30b5\u30a4\u30ba',
  'imageDetails.platform': '\u30d7\u30e9\u30c3\u30c8\u30d5\u30a9\u30fc\u30e0',
  'imageDetails.created': '\u4f5c\u6210\u65e5\u6642',
  'imageDetails.pulling': '\u30a4\u30e1\u30fc\u30b8\u3092\u53d6\u5f97\u4e2d\u2026',
  'imageDetails.notPulled': '\u30a4\u30e1\u30fc\u30b8\u306f\u672a\u53d6\u5f97\u3067\u3059',
  'imageDetails.pull': '\u53d6\u5f97',
  ...
  'deps.title': '依存関係',
  'deps.col.dependency': '依存関係',
  'deps.col.current': '現在',
  'deps.col.available': '利用可能',
  'deps.col.status': 'ステータス',
  'deps.empty': 'この namespace にはインフラ依存関係がありません',
  'deps.status.upToDate': '最新',
  'deps.status.pendingMinor': '{version} は次回の起動時に適用されます',
  'deps.status.upgradeAvailable': 'アップグレードが利用可能',
  'deps.status.requiresLauncherUpdate': 'アップグレードが利用可能 — 新しいランチャーが必要です',
  'deps.upgrade': 'アップグレード',
  'deps.updateLauncher': 'ランチャーを更新',
  'deps.updateLauncherHint': '移行するにはランチャーを更新してください',
  'deps.updateLauncherCli': '移行するにはホストで {cmd} を実行してください',
  'deps.rollbackPending': 'ロールバック待ち: {message}',
  'deps.lastResult.success': '前回の移行: {id} {from} → {to} は成功しました',
  'deps.lastResult.failed': '前回の移行: {id} {from} → {to} は失敗しました: {error}',
  'deps.banner.available': '依存関係のアップグレードが利用可能です: {list}',
  'deps.banner.needLauncher': '次の依存関係には新しいランチャーが必要です: {list}',
  'deps.banner.details': '詳細',
  'deps.banner.dismiss': '閉じる',
  'deps.confirm.intro': '{id} を {from} から {to} へ移行します。データはダンプされ、新しいボリュームにリストアされ、namespace を切り替える前に検証されます。',
  'deps.confirm.start': '移行を開始',
  ...
  'deps.step.pull-image': '新しいイメージを取得しています',
  'deps.step.start-source': '現在のデータベースを起動しています',
  'deps.step.dump': 'データをダンプしています',
  'deps.step.stop-source': '現在のデータベースを停止しています',
  'deps.step.create-volume': '新しいボリュームを作成しています',
  'deps.step.start-target': '新しいデータベースを起動しています',
  'deps.step.restore': 'データをリストアしています',
  'deps.step.verify': '検証しています',
  'deps.step.stop-target': '新しいデータベースを停止しています',
  'deps.result.success': '{id} の移行が完了しました',
  'deps.result.oldVolume': '以前のデータはボリューム {volume} に残っています。不要になったらボリューム画面から削除してください',
  'deps.result.failed': '{id} の移行に失敗しました',
  'deps.result.rolledBack': 'すべてロールバックされました。namespace は以前のバージョンで動作しています',
  'deps.controls.migrating': '依存関係の移行を実行中です',
  'deps.status.blocked': 'アップグレードは不可',
  'deps.status.bundleOlder': 'バンドルは古いバージョンを提供しています',
  'deps.banner.blocked': 'ベンダーによりアップグレードが禁止されています: {list}',
  'deps.confirm.introCopy': '{id} を {from} から {to} へアップグレードします。データボリュームを複製し、その複製をアップグレードして検証してから、ネームスペースを切り替えます。',
  'deps.zk.note': 'ZooKeeper 3.8 と 3.9 はディスク上の形式が同じなので、このアップグレードはコンテナの入れ替えにすぎません。それでもランチャーは先にデータを複製し、将来の形式変更で調整状態を失わないようにします。',
  'deps.step.copy-volume': 'データボリュームを複製しています',
  'deps.step.start-old': '複製上で現在のバージョンを起動しています',
  'deps.step.pre-upgrade': '新しいバージョン向けにデータを準備しています',
  'deps.step.stop-old': '現在のバージョンを停止しています',
  'deps.step.start-new': '新しいバージョンを起動しています',
  'deps.step.post-upgrade': '新しいバージョンでアップグレードを仕上げています',
  'deps.step.stop-new': '新しいバージョンを停止しています',
  'deps.step.switch-generation': '以前のデータボリュームに切り替えています',
  'deps.step.start-namespace': 'ネームスペースを起動しています',
  'deps.progress.rollbackTitle': '{id} をロールバックしています',
  'deps.rollback.action': '{version} に戻す',
  'deps.rollback.field.version': 'バージョン',
  'deps.rollback.field.volume': 'データボリューム',
  'deps.rollback.field.frozen': '保持されるボリューム',
  'deps.rollback.field.migratedAt': '移行日時',
  'deps.rollback.title': '{id} をロールバック',
  'deps.rollback.confirm': 'ロールバック',
  'deps.rollback.unavailable': 'ロールバックできません: {problem}',
  'deps.result.rolledBack.to': '{id} を {to} にロールバックしました',
  'deps.result.rolledBackDone': '{id} を以前のバージョンにロールバックしました',
  'deps.result.frozenVolume': '新しいデータはボリューム {volume} に残ります。ランチャーはそれを保持し、二度と読み取りません',
  'deps.result.rollbackFailed': '{id} のロールバックに失敗しました',
  'deps.result.rollbackUnchanged': '何も変更されていません: 依存関係は以前のバージョンのまま動作しています',
  'deps.controls.rollingBack': '依存関係のロールバックを実行中です',
  ...
  'snapshots.create.volumes': '含めるボリューム',
  'snapshots.create.noVolumes': 'ボリュームがありません',
  ...
  'namespace.form.bundlesRepoHint': 'この一覧はワークスペース設定から取得されます \u2014 リポジトリの追加・変更はワークスペース設定で行ってください。',
