...
[Citeck](https://github.com/Citeck) 是一个自托管的开源 low-code 平台，用于替代专有的 ECM/BPM 套件。几乎任何涉及企业文档的工作，你都能用它来完成——从合同与采购审批，到人力资源流程、电子档案库乃至企业门户。你在内置的 BPMN 设计器中绘制每个流程的流转路线，无需编写代码即可配置文档类型；用户、角色和权限均已开箱即用。
