...
**Требования:** Docker и достаточно оперативной памяти под стек — примерно **16 GB** для редакции Community и **24–32 GB** для ~24 сервисов Enterprise, плюс несколько десятков ГБ диска под образы. Для полноценной ECM/BPM-платформы такого класса это немного.
