...
- La interfaz web ahora está completamente traducida al chino, español, alemán, francés, portugués y japonés: muchos textos que antes aparecían en inglés ahora están localizados.
- Restaurar una instantánea del espacio de nombres ya no corrompe la base de datos: la restauración ahora parte de un volumen limpio en lugar de fusionarse sobre los datos existentes.
